            ...
            <div class="card bg-gradient-dark">
                <div class="card-body p-4">
                    <div class="row align-items-center justify-content-between">
                        <div class="col">
                            <h6 class="text-white mb-0">Manage Payment Category</h6>
                        </div>
                        <div class="col-auto">
                                ...
                                @forelse($Categories as $Category)
                                    <tr>
                                        ...
                                        <td class="text-end pe-3">
                                            <button wire:click="edit({{ $Category->id }})" class="btn btn-link text-dark px-2">
                                                <i class="fa-solid fa-pen-to-square fa-sm"></i>
                                            </button>
                                            <button wire:click="delete({{ $Category->id }})" class="btn btn-link text-danger px-2">
