        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-header pb-0 d-flex justify-content-between align-items-center mb-3">
                    <h5 class="mb-0">Loan Offer Letters</h5>

                    <!-- Common Export Button -->
                    <button wire:click="exportFilteredAgreements" class="btn btn-outline-primary btn-sm"
                        ...
                        <span wire:loading.remove wire:target="exportFilteredAgreements">
                            <i class="fas fa-file-pdf me-2"></i>Export Filtered Offer Letters
                        </span>
