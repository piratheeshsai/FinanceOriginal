<div>
        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-header pb-0 d-flex justify-content-between align-items-center mb-3">
                    <h5 class="mb-0">Promissory Note</h5>

                    <!-- Common Export Button -->
                    <button wire:click="exportFilteredPromissoryOrigin" class="btn btn-outline-primary btn-sm"
                        wire:loading.attr="disabled" wire:target="exportFilteredAgreements">
                        <span wire:loading.remove wire:target="exportFilteredAgreements">
                            <i class="fas fa-file-pdf me-2"></i>Export Filtered Report
                        </span>
                        <span wire:loading wire:target="exportFilteredAgreements">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const bulkExportButton = document.querySelector('[wire\\:click="exportFilteredAgreements"]');
            if (bulkExportButton) {
