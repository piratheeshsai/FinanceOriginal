<div>
        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-header pb-0 d-flex justify-content-between align-items-center mb-3">
                    <h5 class="mb-0">Agreement Lending</h5>

                    <!-- Common Export Button -->
                    <button wire:click="exportFilteredAgreementLending" class="btn btn-outline-primary btn-sm"
                        wire:loading.attr="disabled" wire:target="exportFilteredAgreementLending">
                        <span wire:loading.remove wire:target="exportFilteredAgreementLending">
                            <i class="fas fa-file-pdf me-2"></i>Export Filtered Report
                        </span>
                        <span wire:loading wire:target="exportFilteredAgreementLending">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-end pe-3">
                                        <div class="d-flex justify-content-end gap-1">
                                            ...
                                            <button wire:click="exportSinglePromissory({{ $loan->id }})"
                                                class="btn btn-link text-danger p-1 m-0" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Export Agreement PDF"
                                                wire:loading.attr="disabled"
                                                wire:target="exportSinglePromissory({{ $loan->id }})">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const bulkExportButton = document.querySelector('[wire\\:click="exportFilteredAgreementLending"]');
            if (bulkExportButton) {
