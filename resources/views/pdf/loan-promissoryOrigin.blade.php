...
<body>
    ...
    <div class="document">
        ...
        <p class="line">ரூபா.<strong>{{ $loan->loan_amount }}</strong> இங்கு கீழே கையெழுத்திடும்
            ...
            <strong>({{ $amountInWords }}) </strong> (ரூபா : <strong>{{ $loan->loan_amount }}</strong>) இனை மிகுதியின்றி கடனாகக் கோரி பெற்றுக்கொள்ள
            நேர்ந்துள்ளது.
        </p>
        <br>
         <br>
        ...
        <p class="line">
            ...
            அவ்வாறு செலுத்தி விடுவிப்பு பெறும் வரை முழுத்தொகைக்குமான நாளாந்த/ வராதந்த/ மாதாந்த / அரை வருட / வருடாந்த /
            ஒரு வருடம் ஆறு மாதங்களுக்கு <strong> ({{ $loan->loanScheme->interest_rate }} %) </strong>
            வீதம் வட்டியைச் செலுத்தும் வகையில் உறுதி அளித்து கையொப்பமிடுகிறேன்.
        </p>
        <br>
        <p class="line">மேலும், மேற்குறிப்பிட்ட தொகையான ரூபா <strong> {{ $amountInWords }} </strong>
