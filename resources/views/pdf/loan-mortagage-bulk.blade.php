...
<body>
    ...
    <div class="content-section">
        <p class="paragraph">
            ...
            அதன்படி இலங்கையின் செல்லுபடியான பணத்தில் <span class="amount-highlight">{{ ucfirst($transformer->toWords($loan->loan_amount)) }} rupees
    ...
    <div class="content-section">
        <p class="paragraph">
            ...
            <span class="loan-data">{{ $loan->customer->full_name }}</span> என்பவரால் மேற்குறிப்பிடப்பட்ட
            {{ $company->name ?? 'FINANCE 365' }} ற்கு குறிப்பிடப்பட்ட முழு கடன் தொகை மற்றும்
    ...
    <div class="content-section">
        <p class="paragraph">
            ...
            உண்டென்றும் மேற்குறிப்பிட்ட கடனாளியுடன் ஒன்றாகவோ அல்லது வெவ்வேறாகவோ அல்லது
    ...
    <div class="signature-section">
        <table class="signature-table">
            @foreach ($loan->guarantors->chunk(2) as $pair)
                <tr>
                    @foreach ($pair as $index => $guarantor)
                        <td>
                            <div style="text-align: left; font-size: 12px;">
                                <span class="guarantor-number" style="font-size: 12px;">{{ str_pad($loop->parent->index * 2 + $loop->index + 1, 2, '0', STR_PAD_LEFT) }} ஆம் பிணையாளரின்</span>
