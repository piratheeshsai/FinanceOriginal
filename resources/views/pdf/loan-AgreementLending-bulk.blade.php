    ...
    <div class="document-container">
        ...
        <p class="line">
            ...
            என்பவர் மற்றும் இங்கு பல இடங்களில் கடன் கொடுத்தவர் என குறிப்பிடப்படும் {{ $company->address ?? 'மட்டக்களப்பு' }}.
             இல் அமையப்பெற்ற அலுவலகம் மற்றும் பிரதான வர்த்தக நிலையத்தை நடத்தும் {{ $company->name ?? 'FINANCE 365' }}
        ...
        <p class="line">
            <span class="clause-number">01.</span> மேற்குறிப்பிட்ட "கடனாளி" "கடன் பெற்ற தரப்பு" தமது சுய தொழிலை மேம்படுத்துவதற்கு <strong>Rs {{ ucfirst($transformer->toWords($loan->loan_amount)) }}</strong> rupees only (<strong>Rs.{{ $loan->loan_amount }}</strong>) இனை கடனாளிக்கு வழங்க இணங்குகிறார்.
        </p>
