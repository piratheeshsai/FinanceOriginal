...
class Promissory extends Component
{
    ...
    {
        return view('livewire.documents.promissory', [
            'loans' => Loan::query()
    ...
    public function exportSinglePromissory($loanId)
    {
        $loan = Loan::findOrFail($loanId);

        // Dispatch browser event to trigger download
        $this->dispatch('download-pdf', [
            'url' => route('loan.AgreementLending.export', $loan->id)
        ]);
    ...
    public function exportFilteredAgreementLending()
    {
        ...
        $this->dispatch('download-bulk-pdf', [
            'url' => route('loan.AgreementLending.bulk-export'),
